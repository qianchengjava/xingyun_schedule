...
import com.xingyun.schedule.core.IScheduleDataManager;
import com.xingyun.schedule.core.ScheduleServer;
import com.xingyun.schedule.core.ScheduledMethodRunnable;
import com.xingyun.schedule.util.ScheduleUtil;
import com.xingyun.schedule.zk.ScheduleDataManager4ZK;
import com.xingyun.schedule.zk.ZKManager;
...
public class ZKScheduleManager extends ThreadPoolTaskScheduler implements ApplicationContextAware {
	...
	public void initialData() throws Exception {
		...
		this.scheduleDataManager = new ScheduleDataManager4ZK(this.zkManager,this.serverExpireTime);
		if (this.start == true) {
			// 注册调度管理器
			this.scheduleDataManager.registerScheduleServer(this.currenScheduleServer);
