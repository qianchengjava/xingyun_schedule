package com.xingyun.schedule.zk;
...
import com.xingyun.schedule.DynamicTaskManager;
...
public class ScheduleDataManager4ZK implements IScheduleDataManager {
    ...
    public ScheduleDataManager4ZK(ZKManager aZkManager,Long serverExpireTime) throws Exception {
    	if(serverExpireTime != null){
    		ScheduleDataManager4ZK.SERVER_EXPIRE_TIME = serverExpireTime;
    	}
